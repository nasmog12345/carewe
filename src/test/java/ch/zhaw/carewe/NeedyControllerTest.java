...
class NeedyControllerTest {
    private NeedyRepository needyRepository = Mockito.mock(NeedyRepository.class);
    private NeedyController needyController = new NeedyController();
...
void createNeedyTest() {
    ...
    Needy mockNeedy = new Needy(mockNDTO.getName(), mockNDTO.getEmail(), mockNDTO.getAddress(), mockNDTO.getNumber(),
